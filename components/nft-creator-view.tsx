    ...
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-5 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  disabled={minting}
                  maxLength={200}
                  className="w-full glass-input text-foreground rounded-xl placeholder:text-muted-foreground/60 p-3 min-h-[80px] text-sm focus:outline-none focus:ring-1 focus:ring-primary"
                />
              </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="group relative rounded-2xl bg-gradient-to-br from-indigo-500/5 via-purple-500/10 to-pink-500/5 p-[1px] shadow-md transition duration-500 hover:scale-[1.01] aspect-[3/4]">
            <div className="h-full w-full bg-[#0d0d0f]/90 rounded-2xl p-5 flex flex-col justify-between relative overflow-hidden backdrop-blur-md border border-border/60">
              <div className="flex justify-between items-start">
                <span className="px-1.5 py-0.5 rounded bg-white/5 border border-border text-[9px] text-muted-foreground font-black">
              ...
              <div className="space-y-1">
                <h3 className="text-sm font-bold truncate text-foreground leading-none">
                ...
                <div className="pt-2 border-t border-border/40 flex justify-between items-center text-[9px] text-muted-foreground/60">
